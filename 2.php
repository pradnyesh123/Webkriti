...
<div style="text-align:center;"><h3 class="heading" id="heading"><u>Register yourself for events in Infotsav'18 below...</u></h3></div>
<!-- <br><br><br><br><br><br> -->
<form action="" method="post">
<div class="reg" onmouseenter="hovereffectin()" onmouseleave="hovereffectout()">
	...
	<input type="radio" name="gender" id="Female" value="Female" required>Female</p><br>
...
<label>Please fill in the Events you want to participate!!</label><br>
	<input type="checkbox" name="event[]" id="event1" value="Robowars">Robowars<br>
	<input type="checkbox" name="event[]" id="event2" value="Techathlon">Techathlon<br>
	<input type="checkbox" name="event[]" id="event3" value ="Coding Wars">Coding Wars<br>
	<input type="checkbox" name="event[]" id="event4" value="speakFight">speakFight<br>
	</div>
<div class="submitbtn">
